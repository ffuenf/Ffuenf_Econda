...
class Ffuenf_Econda_ProductsController extends Mage_Core_Controller_Front_Action
{
    protected function _getProductsCsv($store)
    {
        return Mage::getModel('ffuenf_econda/feeds_econda_recommendations_products')->getProductsCsv($store);
    }
